        ...
        <div className="banner-container">
            <div className="banner">
                ...
                <motion.div className="banner-img-wrapper" initial={{ scale: 0, y: 400 }} animate={{ scale: 1, y: 0 }} transition={{ duration: 1.5 }}>
                    <motion.img src="https://firebasestorage.googleapis.com/v0/b/social-media-v2-19789.appspot.com/o/littleAstronaut.svg?alt=media&token=84bd07be-ac99-4521-8fd6-b5906560ed49" className="banner-img" alt="Banner Img" animate={{ y: [0, -10] }} transition={{ duration: 1.5, type: "spring", stiffness: 50, repeat: Infinity, repeatType: "mirror" }} />
                </motion.div>
            </div>
        </div>
    )
